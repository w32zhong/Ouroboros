...
small_model = LlamaForCausalLM.from_pretrained("JackFram/llama-68m", torch_dtype=torch.float16, device_map='cuda', load_in_8bit=True)
...
assert ouroboros_output[:,:64].equal(std_output[:,:64])
